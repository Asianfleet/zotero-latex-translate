...
export class UIExampleFactory {
  ...
  static registerRightClickMenuItem() {
    ...
    ztoolkit.Menu.register("item", {
      tag: "menuitem",
      id: "zotero-itemmenu-zoterolatextranslate-test",
  ...
  static registerRightClickMenuPopup(win: Window) {
    ztoolkit.Menu.register(
      ...
      win.document?.querySelector(
        "#zotero-itemmenu-zoterolatextranslate-test",
      ) as XUL.MenuItem,
    );
  }
...
export class HelperExampleFactory {
  ...
  static clipboardExample() {
    new ztoolkit.Clipboard()
      .addText(
        "![Zotero LaTeX Translate](https://github.com/Asianfleet/zotero-latex-translate)",
        "text/unicode",
      )
      .addText(
        '<a href="https://github.com/Asianfleet/zotero-latex-translate">Zotero LaTeX Translate</a>',
        "text/html",
      )
      .copy();
